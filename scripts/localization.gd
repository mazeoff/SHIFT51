...
const TEXT := {
	"ru": {
		...
		"order_dynamic": "ПОРУЧЕНИЕ: доставьте %s в камеру %s.",
		"bay_a": "A-17 / AMBER", "bay_b": "B-04 / BLUE",
		"artifact_cobalt": "КОБАЛЬТОВЫЙ СОСУД", "artifact_amber": "ЯНТАРНУЮ ПРИЗМУ", "artifact_redacted": "АРХИВ [УДАЛЕНО]",
		"perception_route_a": "Ваш терминал подтверждает янтарный маршрут. Контрольная сумма протокола: A17.",
		"perception_route_b": "Ваш терминал подтверждает синий маршрут. Контрольная сумма протокола: B04.",
		"scan_cobalt": "ПРОВЕРЕННЫЙ ФАКТ: класс COBALT-7 совместим только с B-04 / BLUE. Заряд израсходован.",
		"scan_amber": "ПРОВЕРЕННЫЙ ФАКТ: класс AMBER-3 совместим только с A-17 / AMBER. Заряд израсходован.",
		"scan_redacted": "ПРОВЕРЕННЫЙ ФАКТ: архив [УДАЛЕНО] требует синюю изоляцию B-04. Заряд израсходован.",
		...
		"task_success_dynamic": "СОДЕРЖАНИЕ СТАБИЛЬНО: камера %s приняла контейнер.",
		"task_failure_dynamic": "НАРУШЕНИЕ СОДЕРЖАНИЯ: камера %s отвергла контейнер. Питание повреждено.",
	...
	"en": {
		...
		"order_dynamic": "WORK ORDER: deliver %s to bay %s.",
		"bay_a": "A-17 / AMBER", "bay_b": "B-04 / BLUE",
		"artifact_cobalt": "COBALT VESSEL", "artifact_amber": "AMBER PRISM", "artifact_redacted": "[REDACTED] ARCHIVE",
		"perception_route_a": "Your terminal confirms the amber route. Protocol checksum: A17.",
		"perception_route_b": "Your terminal confirms the blue route. Protocol checksum: B04.",
		"scan_cobalt": "VERIFIED FACT: COBALT-7 class is compatible only with B-04 / BLUE. Charge depleted.",
		"scan_amber": "VERIFIED FACT: AMBER-3 class is compatible only with A-17 / AMBER. Charge depleted.",
		"scan_redacted": "VERIFIED FACT: [REDACTED] archive requires blue isolation B-04. Charge depleted.",
		...
		"task_success_dynamic": "CONTAINMENT STABLE: bay %s accepted the container.",
		"task_failure_dynamic": "CONTAINMENT BREACH: bay %s rejected the container. Power system damaged.",
